...
class SettingDelegate : public QStyledItemDelegate {
  Q_OBJECT
public:
  SettingDelegate(QObject *parent = 0) : QStyledItemDelegate(parent) {}
...
private:
  ...
  void text_flags(QPainter *painter, const QStyleOptionViewItem &option,
  ...
  QVector<QColor> detectors_palette_{
      Qt::darkCyan,   Qt::darkBlue,    Qt::darkGreen, Qt::darkRed,
      Qt::darkYellow, Qt::darkMagenta, Qt::red,       Qt::blue};
};
