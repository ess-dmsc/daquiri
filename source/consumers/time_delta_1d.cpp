...
TimeDelta1D::TimeDelta1D() : Spectrum() {
...
void TimeDelta1D::_apply_attributes() {
  try {
    ...
    std::throw_with_nested(
        std::runtime_error("<TimeDelta1D> Failed _apply_attributes"));
  }
}
...
void TimeDelta1D::_init_from_file() {
  try {
    ...
    std::throw_with_nested(
        std::runtime_error("<TimeDelta1D> Failed _init_from_file"));
  }
}
...
void TimeDelta1D::_recalc_axes() {
  try {
    ...
    std::throw_with_nested(
        std::runtime_error("<TimeDelta1D> Failed _recalc_axes"));
  }
}
