...
SparseMap2D::SparseMap2D() : Dataspace(2) {}

bool SparseMap2D::empty() const { return spectrum_.empty(); }
...
void SparseMap2D::fill_list(EntryList &result, size_t min0, size_t max0,
...
std::string SparseMap2D::data_debug(__attribute__((unused))
