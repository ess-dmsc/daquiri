...
void CoefFunctionFactory::register_type(
...
CoefFunctionPtr
CoefFunctionFactory::create_from_json(const nlohmann::json &j) const {
...
void CoefFunctionFactory::clear() { constructors_.clear(); }
